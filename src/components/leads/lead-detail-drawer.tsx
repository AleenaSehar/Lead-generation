...
const activityIcons: Record<string, string> = { CREATED: "+", UPDATED: "✎", SCORE_CHANGED: "✦", STATUS_CHANGED: "↗", FORM_SUBMITTED: "▤", NOTE_ADDED: "●", ASSIGNED: "◎", EMAIL_SENT: "✉", EMAIL_BOUNCED: "!", EMAIL_COMPLAINED: "!", EMAIL_UNSUBSCRIBED: "×", SUPPRESSION_CHANGED: "⊘", CRM_SYNCED: "◇", CRM_SYNC_FAILED: "!" };
